...
export const TRACKS = [
  ...
  },
  {
    ...
    geometry: {
      ...
      // ~22 m of tarmac. Wider than the real 12 m — this is still a drifting
      // game — but no longer wide enough to pinch the inside of the tight
      // corners the real layout has.
      roadWidth: 180,
      samplesPerSegment: 20,
