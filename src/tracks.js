...
// One road-car tune, copied before per-course unit conversion.
// Keep Manfeild's dedicated race setup separate.
const ROAD_CAR_PHYSICS = Object.freeze({
  arcade: true,
  topSpeedKmh: 100,
  accel: 0.22,
  brakeDecel: 1.2114,
...
export const TRACKS = [
  ...
  },
  {
    ...
    // narrower hill road. Four slower uphill cars give Beryl something to
    // overtake; two descending cars leave gaps to pass in. Uphill speeds rise
    // along the route so the fleet spreads out instead of forming a convoy.
    // They wrap below the summit so the finish stays clear.
    traffic: {
      laneFraction: 0.5,
      ...
      cars: [
        { at: 0.04, direction: 1, speedKmh: 32 },
        { at: 0.66, direction: -1, speedKmh: 60 },
        { at: 0.12, direction: 1, speedKmh: 34 },
        { at: 0.22, direction: 1, speedKmh: 36 },
        { at: 0.32, direction: 1, speedKmh: 38 },
